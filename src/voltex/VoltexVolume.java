...
public class VoltexVolume extends Volume {
	 ...
	 * @param imp
	 */
	public VoltexVolume(Sequence sequence) {
	 ...
	 */
	public VoltexVolume(Sequence sequence, boolean[] ch) {
	 ...
	 *@author Mengmeng
	 */
	public void updateSequenceNoCheckNoUpdate(Sequence sequence, int t, int c)  {
		voltexLoader.setNoCheckNoUpdate(sequence, t, c);
	}
	...
	protected interface VoltexLoader extends Loader {
		 ...
		 * @author Mengmeng
		 */
		void setNoCheckNoUpdate(Sequence sequence, int t, int c) ;
	}
	...
	private final class VoltexByteLoader implements VoltexLoader {
		 ...
		 * @author Mengmeng
		 */
		public void setNoCheckNoUpdate(Sequence sequence, int t, int c) {
			l.setNoCheck(sequence, t, c);
		}
